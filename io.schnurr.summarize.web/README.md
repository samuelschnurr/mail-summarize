...
This project represents the the web project which is wrapped as Microsoft Outlook Addin for the for <a href="https://github.com/samuelschnurr/mail-summarize#mail-summarize-outlook-addin">Mail Summarize</a>. 
...
Start debugging in Outlook Desktop and register the manifest and certificate in your account (alternatively you can  <a href="
